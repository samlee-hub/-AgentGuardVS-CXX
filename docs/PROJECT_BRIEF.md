...
AgentGuardVS-CXX is a C++20 platform for reliability verification and controlled AI coding agent changes across profiled project types.

Its purpose is to sit between an external AI agent and a real engineering workspace:
...
The project focuses on a reliability control layer for AI coding agents:

- `TaskSpec` defines the request, target, acceptance expectations, and repair budget.
- `ProjectProfile` defines detected project kind, languages, source policy, and verification commands.
...
- The implementation began in real Visual Studio C++ engineering and now generalizes through project profiles.
