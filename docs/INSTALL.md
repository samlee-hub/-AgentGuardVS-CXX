...
# Dependencies (nlohmann-json, CLI11, spdlog, gtest) are resolved via vcpkg manifest mode.
# Requires vcpkg installed with the VCPKG_ROOT environment variable set.
